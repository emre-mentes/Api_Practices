...
public class HerokuAppResponsePojo {
    ...
    public HerokuAppResponsePojo(String firstname, String lastname, Integer totalprice, Boolean depositpaid, HerokuAppBookingDatesPojo bookingdates, String additionalneeds) {
